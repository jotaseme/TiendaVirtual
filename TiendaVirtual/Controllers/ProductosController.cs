...
namespace TiendaVirtual.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,nombre,precio,image")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,nombre,precio,image")] Producto producto)
        {
            if (ModelState.IsValid)
            {
